...
<template>
  <nav class="fixed top-3 sm:top-6 left-1/2 -translate-x-1/2 z-50 w-[96%] sm:w-[92%] max-w-4xl">
    <div class="bg-white/90 backdrop-blur-md rounded-2xl border-2 border-black/10 shadow-lg px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between">
      <!-- Logo -->
      <RouterLink to="/" class="flex items-center gap-3 mr-4 lg:mr-12">
      ...
      <div class="hidden md:flex items-center gap-8">
        ...
        <RouterLink to="/community" class="text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-primary transition-colors">Community</RouterLink>
    ...
    <Transition name="mobile-menu">
      <div v-if="showMobileMenu" class="md:hidden mt-2 bg-white/95 backdrop-blur-md rounded-xl border-2 border-black/10 shadow-lg p-4 space-y-1">
        ...
        <RouterLink to="/community" @click="showMobileMenu = false" class="block px-4 py-3 text-sm font-bold uppercase tracking-widest text-slate-600 hover:bg-primary/10 hover:text-primary rounded-lg transition-colors">Community</RouterLink>
